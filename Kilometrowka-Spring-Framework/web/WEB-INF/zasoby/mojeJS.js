...
function drukujNoweOkno(tresc)
{
    ...
    var html = "<html><head><title>Kilometrówka 2015 - Drukuj raport</title><style type=\"text/css\">table, th, td {border: 1px solid black; width: 100%; text-align:center; }</style></head>" +
